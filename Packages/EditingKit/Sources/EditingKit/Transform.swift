...
public enum Matrix4 {
    ...
    /// General row-major 4×4 inverse via cofactor expansion. Returns `nil` when
    /// the matrix is singular (|det| ≈ 0), so callers can fall back to identity.
