...
All four viewer features shipped (environment & lighting #15, debug view modes #12, animation playback transport #13, QuickLook thumbnail/preview extension #14), and the live viewport now renders the edited stage rather than the opened file (#19). The Phase 1 exit surface is complete.
